...
# 创建一个解释器对象
parse = argparse.ArgumentParser(prog="my-我自己的程序",usage="%(prog)s [options] usage",description="my-编写自定义命令行文件",epilog="my-epliog")
...
# 限定范围
parse.add_argument("-s","--sex",default="男",choices=["男","女","female","male"],type=str,help="你的性别")
